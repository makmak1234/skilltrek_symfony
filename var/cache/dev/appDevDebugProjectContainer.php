...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'post_repository' => 'getPostRepositoryService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'skilltrek', 'user' => 'root', 'password' => 8585, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_12befe9655093fa2d1b221b7eeb02ce8e6c00c2e8c463197d47592238e41b990');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Blog\BlogBundle\Repository\PostRepository A Blog\BlogBundle\Repository\PostRepository instance.
     */
    protected function getPostRepositoryService()
    {
        return $this->services['post_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('BlogBlogBundle:Post');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Blog\BlogBundle\Lib\Searcher\Searcher A Blog\BlogBundle\Lib\Searcher\Searcher instance.
     */
    protected function getSearcherService()
    {
        return $this->services['searcher'] = new \Blog\BlogBundle\Lib\Searcher\Searcher($this->get('post_repository'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56a741a6c073d2.97610240')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'skilltrek',
            'database_user' => 'root',
            'database_password' => 8585,
